...
export class ArticleComponent implements OnInit {
  ...
  config() {
    return {
      ...
      media_poster: false,
      content_style: 'img {max-width: 100%;max-height:100%} .iframe { height: 0; position: relative; padding-bottom: 56.25%;} .iframe iframe {left: 0;height: 100%; position: absolute;top: 0; width: 100%;}',
      ...
      menubar: false,
      toolbar: 'undo redo | formatselect | media image bold italic  | \
