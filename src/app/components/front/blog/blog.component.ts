...
export class BlogComponent implements OnInit {
  ...
  goLastPosition(){
    ...
    let returnFromBlog = localStorage.getItem('returnFromBlog');
    if(returnFromBlog?.length){
  ...
  changeList(){
    ...
    if(this.listStyle == true){
      localStorage.setItem('listStyle','yes');
    }else{
      localStorage.setItem('listStyle','no');
    }
  }
